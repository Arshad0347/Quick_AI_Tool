...
const RemoveBackground = () => {
  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700 max-h-[600px]">
      {/*left column*/}
      <form
      ...
      >
        ...
        <input
          ...
          accept="image/*"
          type="file"
          className="w-full p-2 px-3 mt-2 outline-none text-sm font-bold rounded-md border border-gray-300 text-gray-600"
          required
        />
